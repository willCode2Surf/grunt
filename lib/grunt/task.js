...
var parent = require('./task_prototype').create();
...
task.registerMultiTask = function(name, info, fn) {
  ...
  task.registerTask(name, info, function(target) {
    ...
    grunt.util.async.forEachSeries(files, function(fileObj, next) {
      ...
      // TODO: throw away before 0.4 release
      Object.defineProperty(context, 'files', {
        enumerable: true,
        get: function() {
          grunt.log.warn('Inside tasks, this.files is deprecated, use this.file instead.');
          return [fileObj];
        },
        // Attempt to avoid errors caused by this kind of thing:
        // http://bit.ly/W6ilXs
        set: function() {}
      });
